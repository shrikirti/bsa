		...
		<div class="header_bottom_right">			
	        <div class="h_menu4"><!-- start h_menu4 -->
				...
				<ul class="nav">
					...
					<li><a href="products.php">Designers</a></li>
					<li><a href="products.php">Women</a>
						<ul>
							<li><a href="products.php">Accessories</a></li>
							<li><a href="products.php">Ethnic Apparel</a></li>
							<li><a href="products.php">Footwear</a></li>
							<li><a href="products.php">Grooming</a></li>
							<li><a href="products.php">Handbags</a></li>
							<li><a href="products.php">Jewellery</a></li>
						</ul>
					</li>
					<li><a href="products.php">Men</a>
						<ul>
							<li><a href="products.php">Accessories</a></li>
							<li><a href="products.php">Footwear</a></li>
					...
					<li><a href="products.php">Clearence</a></li>
				</ul>
				   ...
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	 <div class="banner-wrap">
				   	       <div class="banner_left">
				   	       	  <img src="images/product.png" class="img-responsive" alt=""/>
				   	       </div>
				   		 	<div class="banner_right">
				   		 		<h1>Open Heart Top</h1>
				   		 		<p class="p1">$13.95</p>
     	...
     	<div class="container">
     		<div class="col-md-9">
		      ...
		      <div class="product_box1">   
		        <ul class="grid-4">
				  ...
				  <li class="grid-4_last"><a href="single.php">
					<div class="view view-first">
     		...
     		<div class="col-md-3 product_right">
			   ...
			   <h3 class="m_1">Featured Products</h3>
				  ...
				  <ul class="grid_1">
					<li class="grid_1-img"><img src="images/s5.jpg" class="img-responsive" alt=""/></li>
					<li class="grid_1-desc">
					  <h4><a href="#">Pintuck Tank</a></h4>
					  <p>$45.55</p>
					</li>
				  ...
				  <ul class="grid_1">
					<li class="grid_1-img"><img src="images/s6.jpg" class="img-responsive" alt=""/></li>
					<li class="grid_1-desc">
					  <h4><a href="#">Pintuck Tank</a></h4>
					  <p>$45.55</p>
					</li>
