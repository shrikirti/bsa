...
<div class="main">
	...
	<p></p>
		<form action = "" onSubmit="return validate(this.name.value,this.iqama.value,this.address.value,this.mobile.value,this.email.value,this.username.value,this.pass.value,this.rePass.value)">
			<ul class="left-form">
			...
			<ul class="right-form">
				<div>
				<li>
					<input type="text"   name = "iqama" placeholder="IQAMA ID" required/>
					<a href="#" class="icon ticker"> </a>
					<div class="clear"> </div>
				</li>
				<li>
