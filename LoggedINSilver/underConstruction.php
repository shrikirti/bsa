...
<title>Bank of Saudi Arabia | Under Construction</title>
<!-- Bootstrap -->
...
function openPopUp(url) {
	newwindow=window.open(url,'Personal Login','height=500,width=1080');
...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">Login</h3>
...
<div class="container">
		<div class="details">
			...
			<img src="images/website_under_construction1.png" alt="" class="img-responsive"/>
			<p class="para"></p>
		</div>
</div>
</div>
