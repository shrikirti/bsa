...
<html>
<head>
<title>Bank of Saudi Arabia | Update Profile</title>
<!-- Bootstrap -->
...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left"><?php echo $_SESSION['name']?></h3>
...
<div class="container">
	...
	<h2>Request for a service</h2>
        ...
        <table align="center" border="0" style="height:70%; width:70%; font-size:24px;" cellpadding="10" >
        <tr>
        <td>Name
        </td>
        <td><!--<input type="text" name="sname" style="width:350px;" id="textbox" id="sname" disabled="true">-->
        <input type="text" name="sname" id="textbox" id="sname">
        </td>
        <br>
        </tr>
        ...
        <td><input type="text" name="address" id="textbox">
        </td>
        </tr>
        ...
        <td><input type="text" name="PhoneNumber" id="textbox">
        </td>
        </tr>
        ...
        <td><input type="text" name="email" id="textbox">
        </td>
        </tr>
        ...
        <td><input type="password" name="password" id="textbox">
        </td>
        </tr>
