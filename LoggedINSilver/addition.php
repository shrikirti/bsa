		...
		<h2>Request for a service</h2>
						<form>
							...
							<select name="service" onchange="window.location=this.options[this.selectedIndex].value">
								...
								<option value="underConstruction.php">underConstruction</option>
								<option value="underConstruction.php">underConstruction or Complaint</option>
							</select>
							</font>
						</form>
						<br><br>
		<h3>Add more info in Profile</h3>
		<form action = "requestReceived.php" onSubmit="return validate(this.name.value,this.iqama.value,this.address.value,this.mobile.value,this.email.value,this.username.value,this.pass.value,this.rePass.value)">
			<ul class="left-form">

				<li>
					<input type="date"   name = "dob" placeholder="Date of Birth"/>
					Date of Birth<a href="#" class="icon ticker"> </a>
					<div class="clear"> </div>
				</li>
