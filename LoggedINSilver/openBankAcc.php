...
<div class="main">
		...
		<h2>Apply for Bank Account with BSA</h2>
		
		<form method="post" action="smsApi.php">
			<table align = 'center'>
			<tr>
				<td><font size="4">Type of Account</font> &nbsp;&nbsp; </td>
				<td><font size="3">
					<select name="type">
						<option value="Savings">Savings Account</option>
						<option value="Salary">Salary Account</option>
						<option value="Johara">Johara Account</option>
			...
			<tr>
				<td></br><font size="4">Enter Nominee</font> &nbsp;&nbsp;</td>
				<td><font size="3">
			...
			<tr><td colspan = 2 align = 'center'></br><font size="3">
