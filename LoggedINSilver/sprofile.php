...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left"><?php echo $_SESSION['name']?>'s Profile</h3>
...
<div class="container">
	<div class="main about span_of_3">
        <div class="details">
        <h3>Hello, <?php echo $_SESSION['login_user']?> <br> your current details are as follows</h3>
