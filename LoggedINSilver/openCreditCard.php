...
<div class="main">
	...
	<h2>Apply for BSA Credit Card</h2>
		<form method="post" action="../AdminAccessOnly/GoldUserRegistration.php">
			<table align = 'center'>
			<tr>
				<td><font size="4">Choose credit card</font> &nbsp;&nbsp; </td>
				<td><font size="3">
					<select name="type">
						<option value="Savings">Visa Platinum Chip</option>
						<option value="Salary">Visa Titanium</option>
						<option value="Johara">Visa Signature</option>
						<option value="Student">MasterCard Gold</option>			
						<option value="Student">MasterCard Platinum Chip</option>
					</select>
				</font>
				</td>
			</tr>
			<tr>
				<td></br><font size="4">Enter monthly Salary</font> &nbsp;&nbsp;</td>
				<td><font size="3">
